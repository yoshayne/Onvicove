...
ALTER TABLE bookings ADD CONSTRAINT bookings_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES staff(id) ON DELETE SET NULL;
...
ALTER TABLE ai_photo_sessions DROP CONSTRAINT IF EXISTS ai_photo_sessions_product_id_fkey;
ALTER TABLE ai_photo_sessions ADD CONSTRAINT ai_photo_sessions_product_id_fkey FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE SET NULL;
