    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Take a final look before your site goes live at {slug ? `${slug}.shopsuitedirect.com` : 'shopsuitedirect.com'}.
        </p>
      </div>
      ...
      <div className="flex flex-col divide-y divide-gray-200 rounded-lg border border-gray-200 bg-white">
        ...
        <SummaryRow label="Site address" value={slug ? `${slug}.shopsuitedirect.com` : '—'} />
