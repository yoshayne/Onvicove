...
import { LayoutDashboard, Building2, Receipt, ScrollText, Menu, X, Settings as SettingsIcon, Tag, Globe } from 'lucide-react';

const navItems = [
  { to: '/admin', label: 'Overview', icon: LayoutDashboard, end: true },
  { to: '/admin/tenants', label: 'Tenants', icon: Building2 },
  { to: '/admin/domain-requests', label: 'Domain Requests', icon: Globe },
